...
export const admins = pgTable("admins", {
  ...
  role: varchar("role", { length: 20 }).notNull().default("demo"),
...
export const customers = pgTable("customers", {
  ...
  lifetimeValue: numeric("lifetime_value", { precision: 12, scale: 2 }).default(
    "0",
  ),
  ...timestamps,
});
export const products = pgTable("products", {
  ...
  status: varchar("status", { length: 30 }).default("In stock"),
  ...timestamps,
});
